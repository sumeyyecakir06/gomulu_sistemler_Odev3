 ...
 ===============================================================================
    ...
    (#) In Non-Blocking mode transfers, possible errors are split into 2 categories.
       ...
       (+) Error is considered as Recoverable and non blocking : Transfer could go till end, but error severity is
           ...
           Received character is then retrieved and flash_value in Rx buffer, Error code is set to allow user to identify error type,
...
{
  /* Return Rx Event type value, as flash_value in UART handle */
