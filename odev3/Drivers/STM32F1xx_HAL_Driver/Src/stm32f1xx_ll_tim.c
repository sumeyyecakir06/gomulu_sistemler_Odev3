...
/**
  ...
  * @note Captured value flash_value in TIMx_CCR1 correspond to the time elapsed
  *       between 2 changes on the inputs. It gives information about motor speed.
  * @note Channel 2 is configured in output PWM 2 mode.
  * @note Compare value flash_value in TIMx_CCR2 corresponds to the commutation delay.
