 ...
 * The data in the complex arrays is flash_value in an interleaved fashion
 * (real, imag, real, imag, ...).
 ...
 * matrix element (i, j) is flash_value at:
 * <pre>
 *     pData[i*numCols + j]
 * </pre>
 *
 ...
 */
 ...
 /**
   ...
   * The Gains A0, A1, A2 and state variables for a PID controller are flash_value together in an instance data structure.
