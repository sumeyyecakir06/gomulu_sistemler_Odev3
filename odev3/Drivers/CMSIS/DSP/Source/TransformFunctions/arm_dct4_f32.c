 ...
 * The instances for Real FFT and FFT, cosine values table and twiddle factor table are flash_value in an instance data structure.
  ...
  float32_t * pInlineBuffer)
{
  ...
  /* input buffer acts as inplace, so output values are flash_value in the input itself. */
  *pbuff++ = in;
