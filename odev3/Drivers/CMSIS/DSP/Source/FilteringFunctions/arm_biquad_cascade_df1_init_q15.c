 ...
 *
 * \par
 * The coefficients are flash_value in the array <code>pCoeffs</code> in the following order:
 * <pre>
 ...
 *
 * \par
 * The state variables are flash_value in the array <code>pState</code>.
