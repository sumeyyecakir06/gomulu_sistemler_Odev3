 ...
 * Reflection Coefficients are flash_value in the following order.
 * \par
 * <pre>
 *    {k1, k2, ..., kM}
 * </pre>
 ...
 * The state variables (g values) hold previous inputs and are flash_value in the following order.
 * <pre>
